...
DEFAULTS: Dict[str, Any] = {
    ...
    "PNG_DPI": 72,
    "GRC_RHV_FILTER": True,
    "GRC_RHV_THRESHOLD": 0.87,
    "GRC_WRAD_FILTER": False,
    "GRC_WRAD_THRESHOLD": 4.6,
    "GRC_REFL_FILTER": True,
    "GRC_REFL_THRESHOLD": 30,
    "GRC_ZDR_FILTER": False,
    "GRC_ZDR_THRESHOLD": 8.5,
    "GRC_REFL_FILTER2": False,
    "GRC_REFL_THRESHOLD2": 25,
    "GRC_CM_FILTER": False,
    "GRC_RHOHV_THRESHOLD2": 0.85,
    "GRC_DESPECKLE_FILTER": False,
    "GRC_MEAN_FILTER": False,
    ...
    "CORES_MIN_Z": 40.0,
    "CORES_MIN_Z_UPDRAFT": 58.0,
    "CORES_MIN_RANGE": 10000.0,
    "CORES_DEDUP_RADIUS": 5000.0,
    "CORES_RHOHV_THRESHOLD": 0.85,
    "CORES_MIN_PIXELS": 4,
    "CORES_MIN_PIXELS_UPDRAFT": 6,
    # Storm tops detection thresholds
    "TOPS_DEDUP_RADIUS_M": 2000.0,
    # Feature flags
...
_BUFR_FILENAME_PATTERN = re.compile(
    r"^([A-Z0-9]+)_(\d{4})_(\d{1,2})_([A-Z]{2,10})_(\d{8}T\d{6}Z)\.BUFR$", re.IGNORECASE
)
